...
export const HELPLINES = [
  { country: 'Global (Crisis Text Line)', number: 'Text HOME to 741741' },
  { country: 'United States (988 Suicide & Crisis Lifeline)', number: '988' },
  { country: 'United Kingdom (Samaritans)', number: '111' },
  { country: 'India (Vandrevala Foundation)', number: '+91 9999 666 555' },
  { country: 'Canada (Talk Suicide Canada)', number: '1-833-456-4566' }
];
...
export const ICONS = {
  ...
  Info: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="16" y2="12"/><line x1="12" x2="12" y1="8" y2="8.01"/></svg>
  )
};
